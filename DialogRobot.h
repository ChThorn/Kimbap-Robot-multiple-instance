...
#define ROBOT_STOP_SPEED    0.0
#define ROBOT_SLOW_SPEED    0.2
#define ROBOT_NORMAL_SPEED  1.0

// Called Class RBTCPServer
class RBTCPServer;
...
public:
    ...
    // Referencing to Another class, RBTCPServer for method name "motionServer"
    // -------
    ...
    void ErrorClear();
    int IsMotionIdle();
    void WriteCommand(QString str, int move_flag);
    void CobotInit();
...
// Create new Class for Network connection
